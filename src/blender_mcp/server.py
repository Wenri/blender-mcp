...
from blender_mcp_core.telemetry_decorator import rich_telemetry_tool
...
# viewport_only's port in this deployment (BlenderMCP/scripts/lib-remote-blender.sh);
...
def get_viewport_screenshot(ctx: Context, max_size: int = 1000, user_prompt: str = "") -> Image:
    ...
    """
    return capture_viewport_screenshot(get_blender_connection, max_size=max_size, user_prompt=user_prompt)
